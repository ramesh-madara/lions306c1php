...
<body>
    ...
    <div>
        <?php foreach ($volunteers as $item) : ?>
            ...
            <div class="regionNameOuter">
                <div class="regionName" value="<?php echo $item['Region_Name']; ?>"><?php echo $item['Region_Name']; ?></div>
            ...
            <?php foreach ($volunteers2 as $item2) : ?>
                <div class="zoneNameOuter">
                    <div class="zoneName"> <?php echo $item2['Zone_Name']; ?></div>
                </div>


                <?php
                $zoneName = $item2['Zone_Name'];
                $fetch3 = "SELECT DISTINCT Club_Name FROM clubs WHERE District_Name = '$district' AND Region_Name = '$regionName' AND Zone_Name = '$zoneName' ORDER BY Club_Name ASC";
                $result3 = mysqli_query($conn, $fetch3);
                $clubs = mysqli_fetch_all($result3, MYSQLI_ASSOC);
                echo $clubs[1]['Club_Name'];
                ?>
                <?php foreach ($clubs as $item3) : ?>
                    <div class="clubNameOuter">
                        <div class="clubName"> <?php echo $item3['Club_Name']; ?></div>
                    </div>
